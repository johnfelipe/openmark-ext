...
public abstract class QComponent
{
	...
	// UNED: 07-10-2011 - dballestin - Changed visibility to public to be able to call this method from 
	//                                 other classes
	...
	public QComponent[] getAncestors()
	{
	 ...
	 */
	public Class<?> getPropertyType(String sName) throws OmDeveloperException
	{
		PropertyDefinition pd=mDefinedProperties.get(sName);
		if (pd==null)
		{
			StringBuffer error=new StringBuffer("Attempt to access undefined property: ");
			error.append(sName);
