...
public class OmService implements ServiceLifecycle, QEngineConfig
{
	  ...
	  throws OmException
	{
		...
		// UNED: 27-05-2013 - dballestin - Added a chance to stop question session on errors when starting a
		//                                 question
		Question q=null;
	 ...
	 * Default implementation does nothing but you can override this method within subclasses 
