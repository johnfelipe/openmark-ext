...
public class RectangleItem extends GraphItem
{
	...
	{
		if(getSize()==null && getCorner2()==null)
	...
	public void paint(Graphics2D g2)
	{
		...
		GraphPoint gpOther=(getCorner2()!=null ? getCorner2() : getCorner1().offset(getSize()));
		Point p1=getCorner1().convert(getWorld()),p2=gpOther.convert(getWorld());
		int
		...
		if(getLineWidth()>0)
		{
			...
			g2.fillRect(iX,iY,iWidth,getLineWidth());
			g2.fillRect(iX,iY+iHeight-getLineWidth(),iWidth,getLineWidth());
			g2.fillRect(iX,iY+getLineWidth(),getLineWidth(),iHeight-2*getLineWidth());
			g2.fillRect(iX+iWidth-getLineWidth(),iY+getLineWidth(),getLineWidth(),iHeight-2*getLineWidth());
		}
	}
