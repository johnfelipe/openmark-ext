...
{
	// UNED: 28-09-2011 - dballestin - Initialization code moved to initParametricFunction method
	/**
	...
	{
		super(w);
		initParametricFunction();
	}
	
	// UNED: 28-09-2011 - dballestin - Initialization code moved from constructor
	protected void initParametricFunction()
	{
	...
	public void paint(Graphics2D g2)
	{
		...
		{
			double t=((double)i/(double)(getSteps()-1))*(getRange().getMax()-getRange().getMin())+getRange().getMin();
			GraphPoint gp=getFunction().f(t);
			float
		...
		g2.setStroke(new BasicStroke((float)getLineWidth()));
		g2.draw(gpPath);
	}
	...
	/**
	 * Get range of t within which to calculate function
	 * @return Range of t within which to calculate function
	 */
	...
	// UNED: 27-09-2011 - dballestin
	/**
	 * Get number of points at which t is evaluated
	 * @return Number of points at which t is evaluated
	 */
	...
	// UNED: 27-09-2011 - dballestin
	/**
	 * Get parametric function color
	 * @return Parametric function color
	 */
