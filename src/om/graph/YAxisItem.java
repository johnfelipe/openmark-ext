...
{
	// UNED: 28-09-2011 - dballestin - Initialization code moved to initYAxis method
	/**
	...
	{
		float
			fX=getWorld().convertXFloat(getX()),
		...
		boolean bRotate,boolean bFlip,boolean bNumbers,int iExtraOffset)
	{
		...
		int iCentreX=getWorld().convertX(getX()),iCentreY=getWorld().convertY(dPoint);
