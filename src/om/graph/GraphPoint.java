...
public class GraphPoint
{
	...
	// UNED: 24-08-2011 - dballestin - Changed access modifier of this method to public so
	//                                 it would be possible to access it from other packages
	/**
	 * @param gsNewX New X value
	 * @return New point with that x value
	 */
	public GraphPoint newX(GraphScalar gsNewX)
	{
	 ...
	 */
	public GraphPoint newY(GraphScalar gsNewY)
	{
