...
public class NavigatorConfig
{
	...
	// UNED: 28-09-2012 - dballestin - Changed access modifier of this constructor to protected so
	//                                 it would be possible to access it from subclasses
	/**
	 * Initialises config.
	 ...
	 */
	protected NavigatorConfig(File fConfig) throws IOException
	{
	...
	// UNED: 01-10-2012 - dballestin - Changed access modifier of this method to protected so
	//                                 it would be possible to be overriden in subclasses
