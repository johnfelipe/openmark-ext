...
public class UserSession
{
	...
	// UNED: 26-11-2012 - dballestin - Changed access modifier of this constructor to protected so
	//                                 it would be possible to invoke it from subclasses
	/**
	 * @param owner
	 */
	...
	/**
	 * Protected setter to be able to set deployment test from subclasses.
	 */
	protected void setTestDeployment(TestDeployment tdDeployment)
	{
		this.tdDeployment=tdDeployment;
	}
	...
	// UNED: 11-10-2012 - dballestin - Changed access modifier of this method to public so
	...
	/**
	 * Getter to be able to access OM service session from other classes.
	 * @return OM service session
	 */
	public OmServiceBalancer.OmServiceSession getOmServiceSession()
	{
		return oss;
	}
	
	// UNED: 09-10-2012 - dballestin
	/**
	 * @return true if user is logged in, false if not
	 */
	public boolean isUserLoggedIn()
	{
		return ud==null?false:ud.isLoggedIn();
	}
	
	// UNED: 22-11-2012 - dballestin
	/**
	 * @return 1 if confirm emails are sent, 0 if confirm mails are not sent, -1 if an error has occurred
	 * when sending confirm emails
	 */
	...
	// UNED: 22-11-2012 - dballestin
	/**
	 * Set the situation when confirm emails are sent or not. 1=sent, 0=not sent, -1=error
	 */
	public void setEmailSent(int iEmailSent)
	{
		this.iEmailSent=iEmailSent;
	}
	
	// UNED: 07-05-2012 - dballestin 
	/**
	 * Getter to be able to access DB sequence from other classes.
	 * @return DB sequence
	 */
	public int getDBSeq()
	{
