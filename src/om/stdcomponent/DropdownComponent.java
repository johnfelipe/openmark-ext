...
public class DropdownComponent extends QComponent
{
	...
	// UNED: 07-07-2011 - dballestin - Changed access modifier of this inner class to protected so
	//                                 it would be possible to access it from subclasses
	// UNED: 07-07-2011 - dballestin - Changed access modifiers of fields of this inner class to public 
