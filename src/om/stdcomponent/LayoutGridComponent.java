...
public class LayoutGridComponent extends QComponent
{
	...
	// UNED: 03-10-2011 - dballestin - Moved fragment code to initialize and shuffle the suffle map
	//                                 to generateShuffleMap(QComponent[] aqcChildren,boolean bShuffle)
	//                                 method
	@Override
	public void produceVisibleOutput(QContent qc,boolean bInit,boolean bPlain) throws OmException
	{
		...
		{
			// UNED: 03-10-2011 - dballestin - Moved fragment code to initialize and shuffle 
			//                                 the suffle map to generateShuffleMap(
			//                                 QComponent[] aqcChildren,boolean bShuffle) method
	...
	// UNED: 03-10-2011 - dballestin - Code moved from fragment code of produceVisibleOutput() method
	/**
