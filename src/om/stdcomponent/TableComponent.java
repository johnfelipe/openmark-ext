...
public class TableComponent extends QComponent
{
	...
	// UNED: 07-12-2011 - dballestin - Changed access modifier of this inner class to protected so
	//                                 it would be possible to access it from subclasses
	// UNED: 07-12-2011 - dballestin - Changed access modifiers of fields of this inner class to public 
	//                                 so it would be possible to access them from other classes
	// UNED: 07-12-2011 - dballestin - Added public constructor so it would be possible to instantiate it 
	//                                 from other classes
	...
	protected class TableRow
	{
		...
		public QComponent[] aqcCells;
	}

	// UNED: 07-12-2011 - dballestin - Changed access modifier of this method to protected so
	//                                 it would be possible to access it from subclasses
	protected int getIntegerIfDefined(String sName, int iDefault)throws OmException
	{
	 ...
	 * @param iHead Number of header rows
	 */
	protected void setHead(int iHead)
	{
		this.iHead=iHead;
	}
	...
	// UNED: 07-12-2011 - dballestin
	/**
	 * @return Number of footer rows
	 */
	protected int getFoot()
	{
		return iFoot;
	}
	...
	// UNED: 07-12-2011 - dballestin
	/**
	 * Set number of footer rows.
	 * @param iFoot Number of footer rows
	 */
	protected void setFoot(int iFoot)
	{
		this.iFoot=iFoot;
	}
	...
	// UNED: 07-12-2011 - dballestin
	/**
	 * @return Number of label columns on left
	 */
	...
	// UNED: 07-12-2011 - dballestin
	/**
	 * Set number of label columns on left.
	 * @param iLeft Number of label columns on left
	 */
	protected void setLeft(int iLeft)
	{
		this.iLeft=iLeft;
	}
	...
	// UNED: 07-12-2011 - dballestin
	/**
	 * @return Number of label columns on right
	 */
	...
	// UNED: 07-12-2011 - dballestin
	/**
	 * Set number of label columns on right.
	 * @param iRight Number of label columns on right
	 */
	protected void setRight(int iRight)
	{
		this.iRight=iRight;
	}
	...
	// UNED: 07-12-2011 - dballestin
	/**
	 * @return Array of table elements (columns etc)
	 */
	protected ArrayList<TableRow> getTableElements()
	{
	...
	// UNED: 07-12-2011 - dballestin
	/**
	 * Set array of table elements (columns etc).
	 * @param tableElements Array of table elements (columns etc)
	 */
	protected void setTableElements(ArrayList<TableRow> tableElements)
	{
	...
	// UNED: 07-12-2011 - dballestin
	/**
	 * @return Text component for title of table
	 */
	protected QComponent getTitle()
	{
		return qcTitle;
	}
	...
	// UNED: 07-12-2011 - dballestin
	/**
	 * Set text component for title of table.
	 * @param qcTitle Text component for title of table
	 */
	protected void setTitle(QComponent qcTitle)
	{
