...
{
	// UNED: 25-11-2011 - dballestin - Changed access modifier of constant to protected so it would be possible 
	//                                 to access it from subclasses
	...
	public void produceVisibleOutput(QContent qc,boolean bInit,boolean bPlain) throws OmException
	{
		...
		else
		{
			...
			if (sFilePath == null || !sFilePath.equals(getString(PROPERTY_FILEPATH)))
			{
				...
				// UNED: 07-03-2012 - dballestin - Changed to get image mime type with a call to a new method:
				//                                 geImageMIME(sFilePath)
				sMimeType=getImageMIME(sFilePath);
	...
	// UNED: 07-03-2012 - dballestin
	/**
	 * Protected getter to be able to access image mime type from subclasses.
	...
	// UNED: 07-03-2012 - dballestin
	/**
	 * Protected getter to be able to access image data from subclasses.
	 * @return Image data
	 */
	...
	// UNED: 07-03-2012 - dballestin
	/**
	 * Protected getter to be able to access image width from subclasses.
	 * @return Image width
	 */
	...
	// UNED: 07-03-2012 - dballestin
	/**
	 * Protected setter to be able to set image width from subclasses.
	 * @param iWidth Image width
	 */
	protected void setImageWidth(int iWidth)
	{
		this.iWidth=iWidth;
	}
	...
	// UNED: 07-03-2012 - dballestin
	/**
	 * Protected getter to be able to access image height from subclasses.
	 * @return Image height
	 */
	...
	// UNED: 07-03-2012 - dballestin
	/**
	 * Protected setter to be able to set image height from subclasses.
	 * @param iWidth Image height
	 */
	protected void setImageHeight(int iHeight)
	{
		this.iHeight=iHeight;
	}
	
	// UNED: 07-03-2012 - dballestin - New method to get image mime type from received file path.
	//                                 Implementation is copied from commented code from produceVisibleOutput.
	/**
	 * @param sFL Image file path
	 * @return Image mime type
	 */
