...
public class WordSelectComponent extends QComponent
{
	...
	// UNED: 14-07-2011 - dballestin - Changed access modifier of this inner class to public so
	//                                 it would be possible to access it from other classes
	// UNED: 14-07-2011 - dballestin - Changed access modifiers of fields of this inner class to public 
	//                                 so it would be possible to access them from other classes
	// UNED: 14-07-2011 - dballestin - Changed access modifiers of constructor of this inner class to 
	//                                 public so it would be possible to instantiate this inner class 
	//                                 from other classes
	/**
	...
	public static class Word
	{
		...
		public boolean isThirdHilight = false;

		public Word(String word, String following, String idTag, int id) {
			this.word = word;
	...
	public static class WordBlock
	{
		...
		public String id;
		public boolean isSecondHighlighted = false;
		public boolean isSW = false;

		public WordBlock(String content, String id, int wordCounter, boolean isSW, boolean isSecondHighlighted) {
			this.id = id;
	 ...
	 */
	protected List<WordBlock> getWordBlocks()
	{
		return wordBlocks;
	}
	...
	// UNED: 14-07-2011 - dballestin
	/**
	 * Get map of words by id
	 * @return Map of words by id
	 */
	protected Map<String, WordBlock> getWordsById()
	{
		return wordsById;
	}
	
	// UNED: 14-07-2011 - dballestin - Changed access modifier of this method to protected so
