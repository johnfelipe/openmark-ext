 ...
 * alt property to make it say something more sensible.<br/><br/>
 ...
 * <tr><td>alt</td><td>(string)</td><td>Optional alt tag, use if the default alternate text is not clear enough.
 * </td></tr>
 ...
 * </table>
 */
public class TextEquationComponent extends om.stdcomponent.TextEquationComponent implements Testable
{
	/**
	...
	{
		PROPERTY_DISPLAY,PROPERTY_ENABLED,PROPERTY_LANG,PROPERTY_TEXTFONT,PROPERTY_ITALIC,PROPERTY_WRAP,
		PROPERTY_ALT,PROPERTY_TEST,PROPERTY_ANSWER,PROPERTY_ATTEMPTSMIN,PROPERTY_ATTEMPTSMAX,
	...
	/**
	 * Tests if this text equation component match all conditions to be displayed.
	 * @param idAnswer Identifier of component selected for answer
	 * @return true if this text equation component match all conditions to be displayed, false otherwise
	 */
	@Override
