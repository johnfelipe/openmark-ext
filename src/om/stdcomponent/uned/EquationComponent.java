...
import om.stdcomponent.TextEquationComponent;
 ...
 */
public class EquationComponent extends om.stdcomponent.EquationComponent implements Testable
{
	/**
	...
	{
		PROPERTY_DISPLAY,PROPERTY_ENABLED,PROPERTY_LANG,PROPERTY_ALT,PROPERTY_TEXTFONT,PROPERTY_TEST,
		PROPERTY_ANSWER,PROPERTY_ATTEMPTSMIN,PROPERTY_ATTEMPTSMAX,PROPERTY_SELECTEDANSWERSMIN,
	...
	/**
	 * Tests if this equation component match all conditions to be displayed.
	 * @param idAnswer Identifier of component selected for answer
	 * @return true if this equation component match all conditions to be displayed, false otherwise
	 */
	@Override
