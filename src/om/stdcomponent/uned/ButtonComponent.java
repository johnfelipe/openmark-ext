 ...
 * </table>
 */
public class ButtonComponent extends om.stdcomponent.ButtonComponent implements Testable
{
	...
	{
		PROPERTY_DISPLAY,PROPERTY_ENABLED,PROPERTY_LANG,PROPERTY_LABEL,PROPERTY_ACTION,PROPERTY_CUSTOM,
	 ...
	 * placeholders.<br/><br/>
	 * Default implementation of this method add a check for 'action' property for checking that a callback method 
	 * is present and correctly defined for its value.<br/><br/>
	...
	/**
	 * Tests if this button component match all conditions to be displayed.
	 * @param idAnswer Identifier of component selected for answer
	 * @return true if this button component match all conditions to be displayed, false otherwise
	 */
	@Override
