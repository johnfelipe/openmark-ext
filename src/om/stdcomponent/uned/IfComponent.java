...
/**
 * Conditionally displays content depending on settings.<br/><br/>
 ...
 * </table>
 */
public class IfComponent extends om.stdcomponent.IfComponent implements Testable
{
	/**
	...
	{
		PROPERTY_DISPLAY,PROPERTY_ENABLED,PROPERTY_LANG,PROPERTY_PLAIN,PROPERTY_TEST,PROPERTY_ANSWER,
	...
	/**
	 * Tests if this text component match all conditions to be displayed.
