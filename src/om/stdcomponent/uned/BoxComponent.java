 ...
 * &lt;layout&gt; section). Contains other controls and text.<br/><br/>
 ...
 * <tr><td>questionLine</td><td>(string)</td><td>Question line to be used if this is 'inputbox' box, 
 * null to use default question line instead</td></tr>
 * <tr><td>answerLine</td><td>(string)</td><td>Answer line to be used if this is 'answerbox' box and
 * user passed the question, null to use default answer line instead</td></tr>
 ...
 * </table>
 */
public class BoxComponent extends om.stdcomponent.BoxComponent implements Testable
{
	/** Property name for position in overall question grid (0 = leftmost) */
	protected static final String PROPERTY_GRIDX="gridx";
	
	/** Property name for position in question grid (0 = topmost) */
	protected static final String PROPERTY_GRIDY="gridy";
	
	/** Property name for width in grid cells */
	protected static final String PROPERTY_GRIDWIDTH="gridwidth";
	
	/** Property name for height in grid cells */
	protected static final String PROPERTY_GRIDHEIGHT="gridheight";
	
	/** Property name for the question line to be used for 'inputbox' box (string) */
	public static final String PROPERTY_QUESTIONLINE="questionline";
	
	/** 
	 * Property name for the answer line to be used for 'answerbox' box (string).<br/>
	 * This answer line will be displayed if user pass the question instead of default text 'Passed'.
	 */
	...
	{
		PROPERTY_DISPLAY,PROPERTY_ENABLED,PROPERTY_LANG,PROPERTY_GRIDX,PROPERTY_GRIDY,PROPERTY_GRIDWIDTH,
		PROPERTY_GRIDHEIGHT,PROPERTY_PLAINHIDE,PROPERTY_BACKGROUND,PROPERTY_QUESTIONLINE,PROPERTY_ANSWERLINE,
	...
	static
	{
		...
		PROPERTIES_TO_INITIALIZE_PLACEHOLDERS_WITH_RESTRICTIONS.put(PROPERTY_BACKGROUND,COLOURCONSTANTS_REGEXP);
	}
	...
	protected void defineProperties() throws OmDeveloperException
	{
		...
		defineString(PROPERTY_QUESTIONLINE);
		setString(PROPERTY_QUESTIONLINE, null);
	...
	/** 
	 * @return Question line to be used for 'inputbox' box, if null the default question line will
	 * be used 
	 */
	public String getQuestionLine()
	{
		try
		{
			return getString(PROPERTY_QUESTIONLINE);
		}
	...
	/**
	 * Sets the question line to be used for 'inputbox' box, set it to null if you want to use
	...
	public void setQuestionLine(String questionLine)
	{
		try
		{
			setString(PROPERTY_QUESTIONLINE,questionLine);
		}
		catch(OmDeveloperException e)
		{
			throw new OmUnexpectedException(e);
	...
	/** 
	 * @return Answer line to be used for 'answerbox' box if user pass the question, if null the 
	 * default answer line will be used
	 */
	...
	/**
	 * Sets the answer line to be used for 'answerbox' box if user pass the question, set it to null
	 * if you want to use default answer line.
	...
	/**
	 * Tests if this box component match all conditions to be displayed.
	 * @param idAnswer Identifier of component selected for answer
	 * @return true if this box component match all conditions to be displayed, false otherwise
	 */
	@Override
