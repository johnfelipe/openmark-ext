...
// UNED: 08-07-2011 - dballestin
/**
 * A component that can be dropped onto DropBoxComponents.<br/><br/>
 * <h2>XML usage</h2>
 * &lt;dragbox/&gt;
 * <h2>Properties</h2>
 * <table border="1">
 ...
 * <tr><td>answerline</td><td>(string)</td><td>Answer line to be used for this dragbox, by default is set 
 * with this dragbox's identifier</td></tr>
 * </table>
 * <h2>Sizing</h2>
 ...
 */
public class DragBoxComponent extends om.stdcomponent.DragBoxComponent
{
	/** Property name for the answer line to be used for this dragbox (string) */
	...
	{
		PROPERTY_DISPLAY,PROPERTY_ENABLED,PROPERTY_LANG,DropBoxComponent.PROPERTY_GROUP,PROPERTY_INFINITE,
		DropBoxComponent.PROPERTY_SIDELABEL,PROPERTY_ANSWERLINE
	};
	...
	static
	{
		...
		PROPERTIES_TO_INITIALIZE_PLACEHOLDERS_WITH_RESTRICTIONS.put(
				DropBoxComponent.PROPERTY_GROUP,DropBoxComponent.PROPERTYREGEXP_GROUP);
		PROPERTIES_TO_INITIALIZE_PLACEHOLDERS_WITH_RESTRICTIONS.put(
				DropBoxComponent.PROPERTY_SIDELABEL,PROPERTYREGEXP_SIDELABEL);
	}
	...
	/** 
	 * @return Answer line to be used for this dragbox, if null the default answer line will be used
	 */
	public String getAnswerLine()
	{
		try
		{
			String answerline=getString(PROPERTY_ANSWERLINE);
			if (answerline==null)
			{
				try
				{
	...
	/**
	 * Sets the answer line to be used for this dragbox, set it to null if you want to use
	 * default answer line.
