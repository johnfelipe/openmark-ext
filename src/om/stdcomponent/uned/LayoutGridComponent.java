 ...
 * </table>
 */
public class LayoutGridComponent extends om.stdcomponent.LayoutGridComponent implements Testable
{
	/** 
	...
	{
		PROPERTY_DISPLAY,PROPERTY_ENABLED,PROPERTY_LANG,PROPERTY_COLS,PROPERTY_SHUFFLE,
		PROPERTY_WIDTHS,PROPERTY_FIXEDPOSITIONS,PROPERTY_RANDOMGROUP,PROPERTY_TEST,PROPERTY_ANSWER,
	...
	private void checkFixedPositions(String fixedPositions) throws OmFormatException
	{
		if (fixedPositions!=null)
		{
			...
			{
				String error="<layoutgrid>: property 'fixedpositions' has an invalid value";
				try
				{
	...
	protected void generateSuffleMap(QComponent[] aqcChildren,boolean bShuffle)
	{
		...
		{
			super.generateSuffleMap(aqcChildren,bShuffle);
		...
		else
		{
			...
			// Set generated shuffle map as layoutgrid's shuffle map
	...
	/**
	 * Tests if this &lt;layoutgrid&gt; component match all conditions to be displayed.
	 * @param idAnswer Identifier of component selected for answer
	 * @return true if this &lt;layoutgrid&gt; component match all conditions to be displayed, 
	 * false otherwise
	 */
	@Override
