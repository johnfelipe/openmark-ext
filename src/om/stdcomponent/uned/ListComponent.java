 ...
 * The list component will arrange the components directly below as a list.<br/><br/>
 ...
 */
public class ListComponent extends om.stdcomponent.ListComponent implements Testable
{
	/** Property name for type of list (string) */
	...
	/** Regular expression restricting types of lists */
	private static final String PROPERTYRESTRICTION_TYPE="bullet|number";
	...
	/**
	 * Tests if this list component match all conditions to be displayed.
	 * @param idAnswer Identifier of component selected for answer
	 * @return true if this list component match all conditions to be displayed, false otherwise
	 */
	@Override
