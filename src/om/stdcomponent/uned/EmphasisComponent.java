 ...
 * <tr><td>type</td><td>(string 'normal'|'bold'|'italic'|'bolditalic')</td>
 * <td>Specifies style of emphasis</td></tr>
...
public class EmphasisComponent extends QComponent
{
	...
	private static final String PROPERTYRESTRICTION_TYPE="normal|bold|italic|bolditalic";
