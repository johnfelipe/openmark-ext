...
/**
 * Represents a flash applet<br/><br/>
 ...
 */
public class FlashComponent extends om.stdcomponent.FlashComponent implements Testable
{
	/**
	...
	/**
	 * Tests if this flash component match all conditions to be displayed.
	 * @param idAnswer Identifier of component selected for answer
	 * @return true if this flash component match all conditions to be displayed, false otherwise
	 */
	@Override
