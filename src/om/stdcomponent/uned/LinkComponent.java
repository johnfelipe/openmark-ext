 ...
 * when any of the contents are clicked upon.<br/><br/>
 ...
 * </table>
 */
public class LinkComponent extends om.stdcomponent.LinkComponent implements Testable
{
	/** Property name for URL to link to (string) */
	...
	{
		PROPERTY_DISPLAY,PROPERTY_ENABLED,PROPERTY_LANG,PROPERTY_URL,PROPERTY_TEST,PROPERTY_ANSWER,
	...
	/**
	 * Tests if this link component match all conditions to be displayed.
	 * @param idAnswer Identifier of component selected for answer
	 * @return true if this link component match all conditions to be displayed, false otherwise
	 */
	@Override
