...
// UNED: 26-07-2011 - dballestin
/**
 * This is a component used to define an answer combination.<br/><br/>
 * This answer can be used as an alternative to the default answer to check answer rightness
 * or can be referenced in answer attribute by testable components or even by other 
 * answer components allowing to define complex answer combinations.<br/><br/>
 * <b>IMPORTANT</b>: Be careful because it can be produced infinite recursion,
 * usually if this answercombo component includes itself in "answer" property 
 * or if other answercombo components included in "answer" property invoke this answercombo 
 * in their "answer" property.<br/><br/>
 ...
 * <br/>
 * <h2>XML usage</h2>
 * &lt;answercombo id="..." right="<i>yes</i>|<i>no</i>|<i>__PLACEHOLDER__</i>" 
 * <i>testing_properties</i> /&gt;
 * <h2>Properties</h2>
 * <table border="1">
 ...
 * <tr><td>lang</td><td>(string)</td><td>Specifies the language of the content, like the HTML 
 * lang attribute. For example 'en' = English, 'el' - Greek, ...</td></tr>
 ...
 * </table>
 */
public class AnswerComboComponent extends QComponent implements Testable
{
	...
	{
		PROPERTY_DISPLAY,PROPERTY_ENABLED,PROPERTY_LANG,PROPERTY_RIGHT,PROPERTY_TEST,PROPERTY_ANSWER,
		PROPERTY_ATTEMPTSMIN,PROPERTY_ATTEMPTSMAX,PROPERTY_SELECTEDANSWERSMIN,PROPERTY_SELECTEDRIGHTANSWERSMAX,
		...
		PROPERTY_UNSELECTEDWRONGANSWERSMAX,PROPERTY_RIGHTDISTANCEMIN,PROPERTY_RIGHTDISTANCEMAX,PROPERTY_ANSWERTYPE,
		PROPERTY_CASESENSITIVE,PROPERTY_TRIM,PROPERTY_STRIP,PROPERTY_SINGLESPACES,PROPERTY_NEWLINESPACE,
		PROPERTY_IGNORE,PROPERTY_IGNOREREGEXP,PROPERTY_IGNOREEMPTYLINES,PROPERTY_TOLERANCE
	};
	...
	/** @return True if the answercombo corresponds to the right answer */
	 ...
	 * @param bRight True to indicate that this answercombo corresponds to the right answer, 
	 * false otherwise
	 */
	...
	/** @return Test for answer checking */
	@Override
	...
	/**
	 * Set the test for answer checking.
	 * @param test Test for answer checking
	 */
	@Override
	...
	/** 
	 * @return Answer's components for answer checking separated by comma ',' 
	...
	/**
	 * Set the answer's components for answer checking separated by comma ',' (OR operator) 
	 * or plus symbol '+' (AND operator), set it to null if you want to remove definition.
	 * @param answer Answer's components for answer checking
	 */
	@Override
	...
	/** @return Minimum number of attempts for answer checking */
	@Override
	...
	/**
	 * Set the minimum number of attempts for answer checking.
	 * @param attemptsMin Minimum number of attempts for answer checking
	 */
	@Override
	...
	/** @return Maximum number of attempts for answer checking */
	@Override
	...
	/**
	 * Set the maximum number of attempts for answer checking.
	 * @param attemptsMax Maximum number of attempts for answer checking
	 */
	@Override
	...
	/** @return Minimum number of selected answers for answer checking */
	@Override
	...
	/**
	 * Set the minimum number of selected answers for answer checking.
	 * @param selectedAnswersMin Minimum number of selected answers for answer checking 
	 */
	@Override
	...
	/** @return Maximum number of selected answers for answer checking */
	@Override
	...
	/**
	 * Set the maximum number of selected answers for answer checking.
	 * @param selectedAnswersMax Maximum number of selected answers for answer checking 
	 */
	@Override
	...
	/** @return Minimum number of selected right answers for answer checking */
	@Override
	...
	/**
	 * Set the minimum number of selected right answers for answer checking.
	 * @param selectedRightAnswersMin Minimum number of selected right answers for answer checking 
	 */
	@Override
	...
	/** @return Maximum number of selected right answers for answer checking */
	@Override
	...
	/**
	 * Set the maximum number of selected right answers for answer checking.
	 * @param selectedRightAnswersMax Maximum number of selected right answers for answer checking
	 */
	@Override
	...
	/** @return Minimum number of selected wrong answers for answer checking */
	@Override
	...
	/**
	 * Set the minimum number of selected wrong answers for answer checking.
	 * @param selectedWrongAnswersMin Minimum number of selected wrong answers for answer checking
	 */
	@Override
	...
	/** @return Maximum number of selected wrong answers for answer checking */
	@Override
	...
	/**
	 * Set the maximum number of selected wrong answers for answer checking.
	 * @param selectedWrongAnswersMax Maximum number of selected wrong answers for answer checking
	 */
	@Override
	...
	/** @return Minimum number of unselected answers for answer checking */
	@Override
	...
	/**
	 * Set the minimum number of unselected answers for answer checking.
	 * @param unselectedAnswersMin Minimum number of unselected answers for answer checking
	 */
	@Override
	...
	/** @return Maximum number of unselected answers for answer checking */
	@Override
	...
	/**
	 * Set the maximum number of unselected answers for answer checking.
	 * @param unselectedAnswersMax Maximum number of unselected answers for answer checking
	 */
	@Override
	...
	/** @return Minimum number of unselected right answers for answer checking */
	@Override
	...
	/**
	 * Set the minimum number of unselected right answers for answer checking.
	 * @param unselectedRightAnswersMin Minimum number of selected right answers for answer checking
	 */
	@Override
	...
	/** @return Maximum number of unselected right answers for answer checking */
	@Override
	...
	/**
	 * Set the maximum number of unselected right answers for answer checking.
	 * @param unselectedRightAnswersMax Maximum number of unselected right answers for answer checking
	 */
	@Override
	...
	/** @return Minimum number of unselected wrong answers for answer checking */
	@Override
	...
	/**
	 * Set the minimum number of unselected wrong answers for answer checking.
	 * @param unselectedWrongAnswersMin Minimum number of unselected wrong answers for answer checking
	 */
	@Override
	...
	/** @return Maximum number of unselected wrong answers for answer checking */
	@Override
	...
	/**
	 * Set the maximum number of unselected wrong answers for answer checking.
	 * @param unselectedWrongAnswersMax Maximum number of unselected wrong answers for answer checking
	 */
	@Override
	...
	/** @return Minimum distance to the right answer for answer checking */
	@Override
	...
	/**
	 * Set the minimum distance to the right answer for answer checking.
	 * @param rightDistanceMin Minimum distance to the right answer for answer checking
	 */
	@Override
	...
	/** @return Maximum distance to the right answer for answer checking */
	@Override
	...
	/**
	 * Set the maximum distance to the right answer for answer checking.
	 * @param rightDistanceMax Maximum distance to the right answer for answer checking
	 */
	@Override
	...
	/** 
	 * @return Answer's type for answer checking with editfield or advancedfield components.<br/>
	...
	/**
	 * Set the answer's type for answer checking with editfield or advancedfield components.<br/>
	 * If it is set to null (default value) then it will be used the answertype property from the 
	 * answer's component.
	 * @param answertype Answer's type for answer checking or null to use the answertype property from 
	...
	/** 
	 * @return "yes" if considering the answer to be case sensitive for answer checking with editfield 
	 ...
	 * for answer checking with editfield or advancedfield components.<br/>
	 ...
	 * for answer checking with editfield or advancedfield components, "no" if it is going 
	...
	/** 
	 * @return "yes" if starting and ending whitespaces from answer are ignored for answer checking
	...
	/**
	 * Set if starting and ending whitespaces from answer are ignored for answer checking
	 ...
	 * for answer checking with editfield or advancedfield components, 
	...
	/** 
	 * @return "yes" if all whitespaces from answer are ignored for answer checking with 
	...
	/**
	 * Set if all whitespaces from answer are ignored for answer checking with editfield or 
	 * advancedfield components.<br/>
	 * If it is null (default value) then it is used the strip property from the answer's component 
	 * (string)
	 * @param strip "yes" if all whitespaces from answer are going to be ignored for answer checking
	 ...
	 * single whitespaces for answer checking with editfield or advancedfield components, 
	 ...
	 * for answer checking with editfield components, "no" if they are not considered as whitespaces 
	...
	/**
	 * Set if new line characters from answer are considered as whitespaces for answer checking
	 ...
	 * whitespaces for answer checking with editfield components, "no" if they are not going 
	...
	/** 
	 * @return "yes" if empty lines from answer are ignored for answer checking with 
	...
	/**
	 * Set if empty lines characters from answer are ignored for answer checking with 
	 * editfield components.<br/>
	 * If it is null (default value) then it is used the ignoreemptylines property from the 
	 * answer's component (string)
	 * @param ignoreemptylines "yes" if empty lines from answer are ignored for answer checking
	...
	/**
	 * Tests if this answercombo component match all conditions for answer checking.
	 * @param idAnswer Identifier of component selected for answer
	 * @return true if this answercombo component match all conditions for answer checking, 
	 * false otherwise
	 */
	@Override
