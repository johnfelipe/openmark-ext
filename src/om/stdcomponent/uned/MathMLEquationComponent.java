 ...
 * </table>
 */
public class MathMLEquationComponent extends om.stdcomponent.MathMLEquationComponent implements Testable
{
	/**
	...
	{
		PROPERTY_DISPLAY,PROPERTY_ENABLED,PROPERTY_LANG,PROPERTY_ALT,PROPERTY_TEST,PROPERTY_ANSWER,
	...
	/**
	 * Tests if this MathML equation component match all conditions to be displayed.
	 * @param idAnswer Identifier of component selected for answer
	 * @return true if this MathML equation component match all conditions to be displayed, false otherwise
	 */
	@Override
