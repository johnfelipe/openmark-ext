...
/**
 * Allows users to play MP3 audio files.<br/><br/>
 ...
 * </table>
 */
public class AudioComponent extends om.stdcomponent.AudioComponent implements Testable
{
	/**
	...
	/**
	 * Tests if this audio component match all conditions to be displayed.
	 * @param idAnswer Identifier of component selected for answer
	 * @return true if this audio component match all conditions to be displayed, false otherwise
	 */
	@Override
