 ...
 * size itself to match other checkboxes on the same grid row.<br/><br/>
 * <h2>XML usage</h2>
 * &lt;checkbox &gt;...&lt;/checkbox&gt;
 * <h2>Properties</h2>
 * <table border="1">
 ...
 * <tr><td>right</td><td>(boolean)</td><td>Whether to consider this checkbox the right answer or not</td></tr>
 * <tr><td>answerline</td><td>(string)</td><td>Answer line to be used for this checkbox, null to use 
 * default answer line instead</td></tr>
 * </table>
 * </table>
 */
public class CheckboxComponent extends om.stdcomponent.CheckboxComponent implements Answerable
{
	/** Property name for the right answer (boolean) */
	public static final String PROPERTY_RIGHT="right";
	
	/** Property name for the answer line to be used for this checkbox (string) */
	...
	{
		PROPERTY_DISPLAY,PROPERTY_ENABLED,PROPERTY_LANG,PROPERTY_HIGHLIGHT,PROPERTY_CHECKED,
	...
	/** @return True if the checkbox corresponds to the right answer */
	@Override
	 ...
	 * @param bRight True to indicate that this checkbox corresponds to the right answer, false otherwise
	 */
	...
	/** 
	 * @return Answer line to be used for this checkbox, if null the default answer line will be used
	 */
	@Override
	...
	/**
	 * Sets the answer line to be used for this checkbox, set it to null if you want to use
	 * default answer line.
