...
public class AppletComponent extends QComponent
{
	...
	// UNED: 29-11-2011 - dballestin - Changed access modifiers of constants to protected
	...
	protected static final String PROPERTY_PARAMS="params";
	...
	// UNED: 30-11-2011 - dballestin - Changed access modifiers of this field to protected
	//                                 so it would be possible to access it from subclasses
